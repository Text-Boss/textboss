# Growth Operator Memory Index

- [project_product_overview.md](project_product_overview.md) — Text Boss product, tiers, pricing, and tech stack fundamentals
- [project_marketing_audit.md](project_marketing_audit.md) — First-session audit: current positioning strengths, gaps, and weaknesses across all 4 marketing pages
